...
if DEVELOPMENT_MODE is True:
    DATABASES = {
        'default': {
            ...
            'NAME': 'railway',
            'USER': 'postgres',
            'PASSWORD': 'VwSJUiVHTEmhLvpnJLNWbVJYabWInObu',
            'HOST': 'roundhouse.proxy.rlwy.net',
            'PORT': '45019',
            'URL':'postgresql://postgres:VwSJUiVHTEmhLvpnJLNWbVJYabWInObu@roundhouse.proxy.rlwy.net:45019/railway'
...
DOMAIN = 'https://blab-api.vercel.app/'
SITE_NAME = 'Full Auth'
